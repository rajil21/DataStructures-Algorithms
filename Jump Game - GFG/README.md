...
You don't need to read input or print anything. Your task is to complete the function <strong>canReach()</strong> which takes a Integer N and a list A of size N as input and returns 1 if the ned of the array is reachable, else return 0.</span></p>
